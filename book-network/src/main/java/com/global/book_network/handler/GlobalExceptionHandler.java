package com.global.book_network.handler;
...
import static com.global.book_network.handler.BusinessErrorCodes.*;
    ...
    public ResponseEntity<ExceptionResponse> handelException(Exception exp) {
        ...
        return ResponseEntity
                ...
                .body(
                        ExceptionResponse
                                .builder()
                                .businessExceptionDescription("Intenal server Error , Please Contact Admin !!")
                                .error(exp.getMessage())
                                .build()
                );
    }
